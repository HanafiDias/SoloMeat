    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Product Dari Toko "{{ auth()->user()->username }}"</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                            ...
                            <form action="/seller/{id}/store" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress"
                                        value="{{ auth()->id() }}" name="user_id" readonly>
                                </div>
                                <div class="form-group">
                    ...
                    <tbody>
                        @foreach ($data as $seller)
                            <tr>
                                ...
                                <td class="border">{{ $seller->produk }}</td>
                                <td class="border">{{ $seller->link_toko_online }}</td>
                                <td class="border">Rp.
                                    {{ number_format($seller->harga) }}</td>
                                <td class="border">{{ $seller->nama_toko }}</td>
                                <td class="border">{{ $seller->nomor_whatsapp }}</td>
                                <td class="border">{{ $seller->counter }}</td>
                                <td class="d-flex ">
                                    <div class="m-1">
                                                    ...
                                                    <form action="/seller/{{ $seller->id }}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="inputAddress2" name="nama_toko"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputAddress">Product Name</label>
                                                            <input type="text" class="form-control"
                                                                id="inputAddress" name="produk"
                                                                placeholder="Name Meat Product"
                                                                value="{{ $seller->produk }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputAddress2">Link E-Commerse</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputAddress2">Harga</label>
                                                            <input type="text" class="form-control"
                                                                id="inputAddress2" placeholder="contoh 50000"
                                                                name="harga" value="{{ $seller->harga }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputAddress">Nomer Whatsapp</label>
                                                            <input type="text" class="form-control"
                                                                id="inputAddress" placeholder="628..."
                                                                name="nomor_whatsapp"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control"
                                                                id="customFile" accept="image/*" name="gambar"
                                                                onchange="preview">
                                                            @if ($seller->gambar)
